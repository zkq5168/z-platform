 ...
 * @date 2022-04-16
 */
public class MapperTemplateHandler extends DefaultTemplateHandler {
    public MapperTemplateHandler(CodeGeneratorDTO codeGeneratorDTO, TTable table) {
        super(codeGeneratorDTO, table);
        this.templatePath = "/template/code/mapper/TemplateMapper.java.template";
