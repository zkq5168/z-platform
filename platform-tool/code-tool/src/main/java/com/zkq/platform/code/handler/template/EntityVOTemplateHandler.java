 ...
 * @date 2022-04-16
 */
public class EntityVOTemplateHandler extends EntityTemplateHandler {
    public EntityVOTemplateHandler(CodeGeneratorDTO codeGeneratorDTO, TTable table) {
        super(codeGeneratorDTO, table);
        this.templatePath = "/template/code/entity/vo/TemplateVO.java.template";
