 ...
 * @date 2022-04-16
 */
public class ServiceImplTemplateHandler extends DefaultTemplateHandler {
    public ServiceImplTemplateHandler(CodeGeneratorDTO codeGeneratorDTO, TTable table) {
        super(codeGeneratorDTO, table);
        this.templatePath = "/template/code/service/impl/TemplateServiceImpl.java.template";
